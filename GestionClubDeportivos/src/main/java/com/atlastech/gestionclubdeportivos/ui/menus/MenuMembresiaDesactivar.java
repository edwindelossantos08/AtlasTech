 ...
 * @author loren
 */
public class MenuMembresiaDesactivar extends javax.swing.JFrame {
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(MenuMembresiaDesactivar.class.getName());
    ...
    private void initComponents() {
        ...
        jPanel11.add(btnGoBack, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 280, -1, 30));
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new MenuMembresiaDesactivar().setVisible(true));
    }
