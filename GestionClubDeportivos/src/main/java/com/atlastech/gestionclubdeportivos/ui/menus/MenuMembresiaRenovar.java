 ...
 * @author loren
 */
public class MenuMembresiaRenovar extends javax.swing.JFrame {
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(MenuMembresiaRenovar.class.getName());

    /**
     * Creates new form MenuMembresiaRenovar
     */
    public MenuMembresiaRenovar() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel21.setText("Renovar membresía");
        ...
        jLabel1.setText("Expira:");
        jPanel11.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 120, 50, -1));

        jLabel2.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(0, 0, 0));
        jLabel2.setText("Renovar por:");
        jPanel11.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 160, 90, -1));

        jLabel3.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(0, 0, 0));
        jLabel3.setText("Nueva expiración:");
        jPanel11.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 200, 130, -1));
        ...
        jPanel11.add(btnGoBack, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 290, -1, 30));

        jComboBox2.setBackground(new java.awt.Color(255, 255, 255));
        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));
        jComboBox2.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        jPanel11.add(jComboBox2, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 160, 160, -1));

        jDateChooser1.setBackground(new java.awt.Color(255, 255, 255));
        jPanel11.add(jDateChooser1, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 200, 130, 30));
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new MenuMembresiaRenovar().setVisible(true));
    }
