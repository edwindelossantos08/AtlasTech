 ...
 * @author loren
 */
public class MenuReservaCancelar extends javax.swing.JFrame {
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(MenuReservaCancelar.class.getName());

    /**
     * Creates new form MenuReservaCancelar
     */
    public MenuReservaCancelar() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel21.setText("Cancelar Reserva");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new MenuReservaCancelar().setVisible(true));
    }
