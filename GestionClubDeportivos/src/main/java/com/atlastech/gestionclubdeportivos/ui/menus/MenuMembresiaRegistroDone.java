 ...
 * @author loren
 */
public class MenuMembresiaRegistroDone extends javax.swing.JFrame {
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(MenuMembresiaRegistroDone.class.getName());

    /**
     * Creates new form MenuMembresiaRegistroDone
     */
    public MenuMembresiaRegistroDone() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel21.setText("¡Miembro registrado con éxito!");
        ...
        jLabel24.setText("¡Gracias por elegir ser parte de nuestro club!");
        ...
        jLabel26.setText("Tu membresía ha sido registrada correctamente. ");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new MenuMembresiaRegistroDone().setVisible(true));
    }
